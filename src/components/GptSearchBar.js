...
const GptSearchBar = () => {
  ...
  return (
    <div className="pt-[6%] flex justify-center m-3 md:m-0">
      <form
        className="bg-black w-full md:w-3/4 lg:w-1/2 grid grid-cols-12"
      ...
      >
        ...
        />
        <button
          className="bg-red-600 text-white rounded-lg m-2 p-2 px-4 col-span-3 "
